...
export default function SettingsPage() {
  ...
  const tabs = [
    ...
    { id: "modules", label: "Modules", icon: <Zap className="h-4 w-4 mr-2" /> },
  ];
          ...
          <TabsContent value="modules">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Enable or disable modules for different user roles
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ModuleManagement />
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <Label>Smart Test Case Suggestions</Label>
                <p className="text-sm text-gray-500">Enable AI-powered test case suggestions based on requirements</p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500">Enable test data generation with customizable fields</p>
              </div>
              <Switch defaultChecked />
            </div>
          </CardContent>
        ...
        {activeTab === 'modules' && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>Enable or disable modules for different user roles and configure module settings</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <ModuleManagement />
            </CardContent>
