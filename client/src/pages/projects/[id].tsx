...
export default function ProjectDetailPage() {
  ...
  const [isTestCaseDialogOpen, setIsTestCaseDialogOpen] = useState(false); // Renamed state variable
  ...
  // Fetch test cases
  const { data: testCases, isLoading: isTestCasesLoading, refetch: refetchTestCases } = useQuery<TestCase[]>({
    ...
    <MainLayout>
      ...
      <Dialog open={testCaseFormOpen} onOpenChange={setTestCaseFormOpen}>
        <DialogContent className="sm:max-w-[700px]">
          ...
          <TestCaseForm 
            testCase={selectedTestCase || undefined}            projectId={projectId}
