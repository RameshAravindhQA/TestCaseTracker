...
import { EnhancedLottie, LottieButton } from "@/components/ui/enhanced-lottie";
import { AnimatedCrudButton } from "@/components/ui/animated-crud-button";
          ...
          <div className="mb-6 flex justify-between items-center">
            ...
            {selectedProjectId && (
              ...
              <DialogTrigger asChild>
                <AnimatedCrudButton operation="create" className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700">
                  Add Test Case
                </AnimatedCrudButton>
              </DialogTrigger>
