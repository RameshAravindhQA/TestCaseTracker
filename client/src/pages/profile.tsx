        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Card className="md:col-span-1">
            <CardHeader>
              ...
              <CardDescription>Update your profile picture or choose an avatar</CardDescription>
            </CardHeader>
            <CardContent className="flex flex-col items-center">
              ...
              <div className="grid grid-cols-4 gap-4 mt-4">
                <div className="w-16 h-16 border-2 border-gray-200 rounded-full overflow-hidden cursor-pointer hover:border-blue-500">
                  <EnhancedLottie
                    customUrl="/attached_assets/Profile Avatar of Young Boy_1752294847420.json"
                    size="lg"
                    loop={true}
                    autoplay={true}
                  />
                ...
                <div className="w-16 h-16 border-2 border-gray-200 rounded-full overflow-hidden cursor-pointer hover:border-blue-500">
                  <EnhancedLottie
                    customUrl="/attached_assets/Female 05_1752294849174.json"
                    size="lg"
                    loop={true}
                    autoplay={true}
                  />
                ...
                <div className="w-16 h-16 border-2 border-gray-200 rounded-full overflow-hidden cursor-pointer hover:border-blue-500">
                  <EnhancedLottie
                    customUrl="/attached_assets/Business team_1752294842244.json"
                    size="lg"
                    loop={true}
                    autoplay={true}
                  />
                ...
                <div className="w-16 h-16 border-2 border-gray-200 rounded-full overflow-hidden cursor-pointer hover:border-blue-500">
                  <EnhancedLottie
                    customUrl="/attached_assets/Businessman flies up with rocket_1752294839035.json"
                    size="lg"
                    loop={true}
                    autoplay={true}
                  />
