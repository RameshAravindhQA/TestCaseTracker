  ...
  return (
    <Switch>
      ...
      <Route path="/spreadsheets">
        <ProtectedLazyComponent Component={lazy(() => import("./pages/spreadsheets"))} />
      </Route>
      <Route path="/enhanced-spreadsheets">
        <ProtectedLazyComponent Component={lazy(() => import("./pages/enhanced-spreadsheets"))} />
      </Route>
      <Route path="/github">
