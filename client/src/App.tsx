...
const LoadingSpinner = () => (
  <div className="min-h-screen flex items-center justify-center">
    <InlineNavadhitiLoader size="lg" text="Loading application..." />
  </div>
);
const LoadingComponent = () => (
  <div className="flex flex-col items-center justify-center min-h-screen">
    <InlineNavadhitiLoader size="xl" text="Loading component..." />
  </div>
);
  ...
  return (
    <Switch>
      ...
      <Route path="/smart-suggestions">
        <ProtectedLazyComponent Component={lazy(() => import("./pages/smart-suggestions/index"))} />
      </Route>
      <Route path="/test-data">
        <ProtectedLazyComponent Component={lazy(() => import("./pages/test-data/index"))} />
      </Route>
      <Route path="/bugs">
      ...
      <Route path="/api-testing">
        <ProtectedLazyComponent Component={lazy(() => import("@/pages/api-testing"))} />
      </Route>
      <Route path="/user-guide">
        <ProtectedLazyComponent Component={lazy(() => import("./pages/user-guide/index"))} />
      </Route>
      <Route path="/test-data">
        <ProtectedLazyComponent Component={lazy(() => import("./pages/test-data/index"))} />
      </Route>
