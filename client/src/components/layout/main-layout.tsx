...
import { GlobalIssueReporter } from '@/components/global/global-issue-reporter';
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <main className={cn(
        ...
        {children}
        <TodoToggleButton />
                {/* Global Issue Reporter Toggle */}
        <GlobalIssueToggle onToggle={() => setShowIssueReporter(!showIssueReporter)} />

        {/* Global Issue Reporter */}
        {showIssueReporter && (
          <GlobalIssueReporter onClose={() => setShowIssueReporter(false)} />
        )}
      </main>
