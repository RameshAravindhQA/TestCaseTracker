  ...
  return (
    ...
    >
      ...
      <div className="flex items-center p-4 border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900">
        ...
        <LottieAvatar
          fallbackInitials={user?.firstName?.[0] + user?.lastName?.[0] || 'U'}
          size="md"
          className="h-8 w-8"
        />
        {useMemo(() => (
            ...
            navItems.map((item) => (
              <div key={item.href}>
                <Link 
                  ...
                  className={cn(
                    "sidebar-item flex items-center justify-between px-2 py-2 text-sm font-medium rounded-md group",
