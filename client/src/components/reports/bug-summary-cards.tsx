  ...
  const summaryData = [
    {
      ...
      value: totalBugsAll,
      icon: AlertTriangle,
      bgGradient: "bg-gradient-to-br from-zinc-950 via-black to-stone-950 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.8)] border border-zinc-900/90",
    ...
    },
    {
      ...
      icon: Shield,
      bgGradient: "bg-gradient-to-br from-red-950 via-black to-red-950 shadow-[0_25px_50px_-12px_rgba(220,38,38,0.5)] border border-red-950/90",
    ...
    },
    {
      ...
      value: majorBugsAll,
      icon: Zap,
      bgGradient: "bg-gradient-to-br from-orange-950 via-black to-amber-950 shadow-[0_25px_50px_-12px_rgba(251,146,60,0.4)] border border-orange-950/90",
    ...
    },
    {
      ...
      value: minorBugsAll,
      icon: Info,
      bgGradient: "bg-gradient-to-br from-yellow-950 via-black to-amber-950 shadow-[0_25px_50px_-12px_rgba(250,204,21,0.3)] border border-yellow-950/90",
    ...
    },
    {
      ...
      icon: Star,
      bgGradient: "bg-gradient-to-br from-slate-950 via-black to-gray-950 shadow-[0_25px_50px_-12px_rgba(71,85,105,0.4)] border border-slate-950/90",
    ...
    },
    {
      ...
      value: openBugsAll,
      icon: Clock,
      bgGradient: "bg-gradient-to-br from-rose-950 via-black to-pink-950 shadow-[0_25px_50px_-12px_rgba(244,63,94,0.4)] border border-rose-950/90",
    ...
    },
    {
      ...
      icon: Clock,
      bgGradient: "bg-gradient-to-br from-blue-950 via-black to-indigo-950 shadow-[0_25px_50px_-12px_rgba(59,130,246,0.4)] border border-blue-950/90",
    ...
    },
    {
      ...
      value: resolvedBugs,
      icon: CheckCircle,
      bgGradient: "bg-gradient-to-br from-green-950 via-black to-emerald-950 shadow-[0_25px_50px_-12px_rgba(34,197,94,0.4)] border border-green-950/90",
    ...
    },
    {
      ...
      value: closedBugs,
      icon: CheckCircle,
      bgGradient: "bg-gradient-to-br from-purple-950 via-black to-violet-950 shadow-[0_25px_50px_-12px_rgba(147,51,234,0.4)] border border-purple-950/90",
