  ...
  const summaryData = [
    {
      ...
      value: totalBugsAll,
      icon: AlertTriangle,
      bgGradient: "bg-gradient-to-br from-gray-900 via-black to-gray-900 shadow-2xl border border-gray-800/90",
    ...
    },
    {
      ...
      icon: Shield,
      bgGradient: "bg-gradient-to-br from-red-900 via-red-950 to-black shadow-2xl border border-red-800/90",
      textColor: "text-white", 
    ...
    },
    {
      ...
      value: majorBugsAll,
      icon: Zap,
      bgGradient: "bg-gradient-to-br from-orange-900 via-orange-950 to-black shadow-2xl border border-orange-800/90",
      textColor: "text-white",
    ...
    },
    {
      ...
      value: minorBugsAll,
      icon: Info,
      bgGradient: "bg-gradient-to-br from-yellow-900 via-yellow-950 to-black shadow-2xl border border-yellow-800/90",
      textColor: "text-white",
    ...
    },
    {
      ...
      icon: Star,
      bgGradient: "bg-gradient-to-br from-slate-900 via-slate-950 to-black shadow-2xl border border-slate-800/90",
      textColor: "text-white",
    ...
    },
    {
      ...
      value: openBugsAll,
      icon: Clock,
      bgGradient: "bg-gradient-to-br from-rose-900 via-rose-950 to-black shadow-2xl border border-rose-800/90",
      textColor: "text-white",
    ...
    },
    {
      ...
      icon: Clock,
      bgGradient: "bg-gradient-to-br from-blue-900 via-blue-950 to-black shadow-2xl border border-blue-800/90",
      textColor: "text-white",
    ...
    },
    {
      ...
      value: resolvedBugs,
      icon: CheckCircle,
      bgGradient: "bg-gradient-to-br from-green-900 via-green-950 to-black shadow-2xl border border-green-800/90",
      textColor: "text-white",
    ...
    },
    {
      ...
      value: closedBugs,
      icon: CheckCircle,
      bgGradient: "bg-gradient-to-br from-purple-900 via-purple-950 to-black shadow-2xl border border-purple-800/90",
      textColor: "text-white",
