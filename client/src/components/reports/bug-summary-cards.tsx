  ...
  const summaryData = [
    {
      ...
      value: totalBugsAll,
      icon: AlertTriangle,
      bgGradient: "bg-gradient-to-br from-gray-900 via-gray-950 to-black shadow-[0_25px_50px_-12px_rgba(0,0,0,0.9)] border border-gray-800/90",
    ...
    },
    {
      ...
      icon: Shield,
      bgGradient: "bg-gradient-to-br from-red-900 via-red-950 to-black shadow-[0_25px_50px_-12px_rgba(185,28,28,0.8)] border border-red-800/90",
    ...
    },
    {
      ...
      value: majorBugsAll,
      icon: Zap,
      bgGradient: "bg-gradient-to-br from-orange-900 via-orange-950 to-black shadow-[0_25px_50px_-12px_rgba(194,65,12,0.8)] border border-orange-800/90",
    ...
    },
    {
      ...
      value: minorBugsAll,
      icon: Info,
      bgGradient: "bg-gradient-to-br from-yellow-900 via-yellow-950 to-black shadow-[0_25px_50px_-12px_rgba(161,98,7,0.8)] border border-yellow-800/90",
    ...
    },
    {
      ...
      icon: Star,
      bgGradient: "bg-gradient-to-br from-slate-900 via-slate-950 to-black shadow-[0_25px_50px_-12px_rgba(51,65,85,0.8)] border border-slate-800/90",
    ...
    },
    {
      ...
      value: openBugsAll,
      icon: Clock,
      bgGradient: "bg-gradient-to-br from-rose-900 via-rose-950 to-black shadow-[0_25px_50px_-12px_rgba(190,18,60,0.8)] border border-rose-800/90",
    ...
    },
    {
      ...
      icon: Clock,
      bgGradient: "bg-gradient-to-br from-blue-900 via-blue-950 to-black shadow-[0_25px_50px_-12px_rgba(30,64,175,0.8)] border border-blue-800/90",
    ...
    },
    {
      ...
      value: resolvedBugs,
      icon: CheckCircle,
      bgGradient: "bg-gradient-to-br from-green-900 via-green-950 to-black shadow-[0_25px_50px_-12px_rgba(21,128,61,0.8)] border border-green-800/90",
    ...
    },
    {
      ...
      value: closedBugs,
      icon: CheckCircle,
      bgGradient: "bg-gradient-to-br from-purple-900 via-purple-950 to-black shadow-[0_25px_50px_-12px_rgba(107,33,168,0.8)] border border-purple-800/90",
