  ...
  const summaryData = [
    {
      ...
      value: totalBugsAll,
      icon: AlertTriangle,
      bgGradient: "bg-gradient-to-br from-black via-slate-950 to-black shadow-2xl border border-slate-900/90",
    ...
    },
    {
      ...
      icon: Shield,
      bgGradient: "bg-gradient-to-br from-red-950 via-black to-red-950 shadow-2xl border border-red-900/80",
      textColor: "text-white", 
    ...
    },
    {
      ...
      value: majorBugsAll,
      icon: Zap,
      bgGradient: "bg-gradient-to-br from-orange-950 via-black to-orange-950 shadow-2xl border border-orange-900/80",
      textColor: "text-white",
    ...
    },
    {
      ...
      value: minorBugsAll,
      icon: Info,
      bgGradient: "bg-gradient-to-br from-yellow-950 via-black to-yellow-950 shadow-2xl border border-yellow-900/80",
      textColor: "text-white",
    ...
    },
    {
      ...
      icon: Star,
      bgGradient: "bg-gradient-to-br from-neutral-950 via-black to-neutral-950 shadow-2xl border border-neutral-900/80",
      textColor: "text-white",
    ...
    },
    {
      ...
      value: openBugsAll,
      icon: Clock,
      bgGradient: "bg-gradient-to-br from-rose-950 via-black to-rose-950 shadow-2xl border border-rose-900/80",
      textColor: "text-white",
    ...
    },
    {
      ...
      icon: Clock,
      bgGradient: "bg-gradient-to-br from-blue-950 via-black to-blue-950 shadow-2xl border border-blue-900/80",
      textColor: "text-white",
    ...
    },
    {
      ...
      value: resolvedBugs,
      icon: CheckCircle,
      bgGradient: "bg-gradient-to-br from-green-950 via-black to-green-950 shadow-2xl border border-green-900/80",
      textColor: "text-white",
    ...
    },
    {
      ...
      value: closedBugs,
      icon: CheckCircle,
      bgGradient: "bg-gradient-to-br from-violet-950 via-black to-violet-950 shadow-2xl border border-violet-900/80",
      textColor: "text-white",
