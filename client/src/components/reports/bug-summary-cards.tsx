  ...
  const summaryData = [
    {
      ...
      value: totalBugsAll,
      icon: AlertTriangle,
      bgGradient: "bg-gradient-to-br from-indigo-700 via-blue-800 to-cyan-700",
    ...
    },
    {
      ...
      icon: Shield,
      bgGradient: "bg-gradient-to-br from-red-700 via-rose-800 to-pink-700",
      textColor: "text-white", 
      iconColor: "text-white",
    },
    {
      ...
      value: majorBugsAll,
      icon: Zap,
      bgGradient: "bg-gradient-to-br from-orange-700 via-amber-800 to-yellow-700",
      textColor: "text-white",
      iconColor: "text-white",
    },
    {
      ...
      value: minorBugsAll,
      icon: Info,
      bgGradient: "bg-gradient-to-br from-yellow-700 via-lime-800 to-green-700",
      textColor: "text-white",
      iconColor: "text-white",
    },
    {
      ...
      icon: Star,
      bgGradient: "bg-gradient-to-br from-slate-700 via-gray-800 to-zinc-700",
      textColor: "text-white",
      iconColor: "text-white",
    },
    {
    ...
    },
    {
      ...
      icon: Clock,
      bgGradient: "bg-gradient-to-br from-purple-700 via-violet-800 to-indigo-700",
      textColor: "text-white",
      iconColor: "text-white",
    },
    {
      ...
      value: resolvedBugs,
      icon: CheckCircle,
      bgGradient: "bg-gradient-to-br from-emerald-700 via-green-800 to-teal-700",
      textColor: "text-white",
      iconColor: "text-white",
    },
    {
      ...
      value: closedBugs,
      icon: CheckCircle,
      bgGradient: "bg-gradient-to-br from-purple-800 via-violet-900 to-indigo-800",
      textColor: "text-white",
      iconColor: "text-white",
    },
  ];
