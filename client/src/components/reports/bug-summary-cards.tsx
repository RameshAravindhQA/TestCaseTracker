  ...
  const summaryData = [
    {
      ...
      value: totalBugsAll,
      icon: AlertTriangle,
      bgGradient: "bg-gradient-to-br from-black via-slate-900 to-gray-900 shadow-2xl border border-slate-800/80",
    ...
    },
    {
      ...
      icon: Shield,
      bgGradient: "bg-gradient-to-br from-red-950 via-red-900 to-black shadow-2xl border border-red-800/80",
      textColor: "text-white", 
    ...
    },
    {
      ...
      value: majorBugsAll,
      icon: Zap,
      bgGradient: "bg-gradient-to-br from-orange-950 via-orange-900 to-red-950 shadow-2xl border border-orange-800/80",
      textColor: "text-white",
    ...
    },
    {
      ...
      value: minorBugsAll,
      icon: Info,
      bgGradient: "bg-gradient-to-br from-yellow-950 via-yellow-900 to-orange-950 shadow-2xl border border-yellow-800/80",
      textColor: "text-white",
    ...
    },
    {
      ...
      icon: Star,
      bgGradient: "bg-gradient-to-br from-gray-950 via-slate-900 to-black shadow-2xl border border-gray-800/80",
      textColor: "text-white",
    ...
    },
    {
      ...
      value: openBugsAll,
      icon: Clock,
      bgGradient: "bg-gradient-to-br from-red-950 via-red-900 to-rose-950 shadow-2xl border border-red-800/80",
      textColor: "text-white",
      iconColor: "text-red-300",
    },
    {
      ...
      icon: Clock,
      bgGradient: "bg-gradient-to-br from-purple-950 via-purple-900 to-indigo-950 shadow-2xl border border-purple-800/80",
      textColor: "text-white",
    ...
    },
    {
      ...
      value: resolvedBugs,
      icon: CheckCircle,
      bgGradient: "bg-gradient-to-br from-emerald-950 via-emerald-900 to-green-950 shadow-2xl border border-emerald-800/80",
      textColor: "text-white",
    ...
    },
    {
      ...
      value: closedBugs,
      icon: CheckCircle,
      bgGradient: "bg-gradient-to-br from-indigo-950 via-indigo-900 to-purple-950 shadow-2xl border border-indigo-800/80",
      textColor: "text-white",
