  ...
  const summaryData = [
    {
      ...
      value: totalBugsAll,
      icon: AlertTriangle,
      bgGradient: "bg-gradient-to-br from-slate-900 via-gray-800 to-zinc-900 shadow-2xl border border-slate-700/50",
    ...
    },
    {
      ...
      icon: Shield,
      bgGradient: "bg-gradient-to-br from-red-900 via-rose-800 to-pink-900 shadow-2xl border border-red-700/50",
      textColor: "text-white", 
    ...
    },
    {
      ...
      value: majorBugsAll,
      icon: Zap,
      bgGradient: "bg-gradient-to-br from-orange-900 via-amber-800 to-yellow-900 shadow-2xl border border-orange-700/50",
      textColor: "text-white",
    ...
    },
    {
      ...
      value: minorBugsAll,
      icon: Info,
      bgGradient: "bg-gradient-to-br from-yellow-800 via-lime-700 to-green-800 shadow-2xl border border-yellow-600/50",
      textColor: "text-white",
    ...
    },
    {
      ...
      icon: Star,
      bgGradient: "bg-gradient-to-br from-slate-800 via-gray-700 to-zinc-800 shadow-2xl border border-slate-600/50",
      textColor: "text-white",
    ...
    },
    {
      ...
      value: openBugsAll,
      icon: Clock,
      bgGradient: "bg-gradient-to-br from-red-800 via-rose-700 to-pink-800 shadow-2xl border border-red-600/50",
      textColor: "text-white",
      iconColor: "text-red-200",
    },
    {
      ...
      icon: Clock,
      bgGradient: "bg-gradient-to-br from-purple-900 via-violet-800 to-indigo-900 shadow-2xl border border-purple-700/50",
      textColor: "text-white",
    ...
    },
    {
      ...
      value: resolvedBugs,
      icon: CheckCircle,
      bgGradient: "bg-gradient-to-br from-emerald-900 via-green-800 to-teal-900 shadow-2xl border border-emerald-700/50",
      textColor: "text-white",
    ...
    },
    {
      ...
      value: closedBugs,
      icon: CheckCircle,
      bgGradient: "bg-gradient-to-br from-purple-800 via-violet-700 to-indigo-800 shadow-2xl border border-purple-600/50",
      textColor: "text-white",
      iconColor: "text-purple-200",
    },
  ];
