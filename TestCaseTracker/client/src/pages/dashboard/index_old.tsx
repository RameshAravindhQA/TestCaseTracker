...
<div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      {/* All tutorial dialogs removed to prevent blur screen issues */}

      {/* All tutorial components removed to prevent blur screen issues */}
    </MainLayout>
  );
}
// All dialog and tutorial components removed to prevent blur screen issues
