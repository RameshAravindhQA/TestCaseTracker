...
export default function KanbanPage() {
  ...
  return (
    <MainLayout>
      <div className="h-full bg-gray-100 p-6 min-h-screen overflow-hidden overflow-auto scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-200 hover:scrollbar-thumb-gray-600">
